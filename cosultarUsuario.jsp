    ...
    <body id="Body2">
        ...
        <div id="Conteúdo">
            ...
            <form action="pesquisaUsuario" method="Post">
                <h3 class="text-center">Cosultar Usuario</h3>
                <div class="form-group">
                    <label for="nome" class="btn bt-primary m-auto form-control-file">Nome</label>
                    <input type="text" id="nome" name="nome" class="form-control d-grid gap-0 col-md-9 mx-auto" style="background-color: #ccffcc;">
                </div>
                <div class="form-group">
                    <label for="nome" class="btn bt-primary m-auto form-control-range">CPF</label>
                    <input type="text" id="cpf" name="cpf" class="form-control d-grid gap-0 col-md-9 mx-auto" style="background-color: #ccffcc;">
                </div>
                <div class="col-lg-12">
                    <button class="btn btn-primary btn-sm form-control d-grid gap-0 col-md-3 mx-auto" tabindex="6">Pesquisa</button>
                </div>
            </form>
            <br>
            <div class="col-lg-12">
                <a href="cadastrarUsuario.jsp"><button class="btn btn-primary btn-sm form-control d-grid gap-0 col-md-3 mx-auto" tabindex="6">Cadastrar</button></a>
            </div>
